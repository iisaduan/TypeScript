...
/** @internal */
export const inverseJsxOptionMap = new Map<string, string>(mapIterator(jsxOptionMap.entries(), ([key, value]: [string, JsxEmit]) => ["" + value, key] as const));
 ...
 * @internal
 */
export const libMap = new Map<string, string>(libEntries);
