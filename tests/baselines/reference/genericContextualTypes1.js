...
declare const arrayMap: <T extends {} | null | undefined, U extends {} | null | undefined>(f: (x: T) => U) => (a: T[]) => U[];
declare const arrayFilter: <T extends {} | null | undefined>(f: (x: T) => boolean) => (a: T[]) => T[];
