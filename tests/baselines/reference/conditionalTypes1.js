...
type Foo<T> = T extends string ? boolean : number;
type Bar<T> = T extends string ? boolean : number;
declare const convert: <U extends {} | null | undefined>(value: Foo<U>) => Bar<U>;
type Baz<T> = Foo<T>;
declare const convert2: <T extends {} | null | undefined>(value: Foo<T>) => Baz<T>;
declare function f31<T>(): void;
declare function f32<T, U>(): void;
declare function f33<T, U>(): void;
type T90<T> = T extends 0 ? 0 : () => 0;
type T91<T> = T extends 0 ? 0 : () => 0;
declare const f40: <U extends {} | null | undefined>(a: T90<U>) => T91<U>;
declare const f41: <U extends {} | null | undefined>(a: T91<U>) => T90<U>;
type T92<T> = T extends () => 0 ? () => 1 : () => 2;
type T93<T> = T extends () => 0 ? () => 1 : () => 2;
declare const f42: <U extends {} | null | undefined>(a: T92<U>) => T93<U>;
declare const f43: <U extends {} | null | undefined>(a: T93<U>) => T92<U>;
type T94<T> = T extends string ? true : 42;
type T95<T> = T extends string ? boolean : number;
declare const f44: <U extends {} | null | undefined>(value: T94<U>) => T95<U>;
declare const f45: <U extends {} | null | undefined>(value: T95<U>) => T94<U>;
