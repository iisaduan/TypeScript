...
type IfEquals<X, Y, A, B> = (<T>() => T extends X ? 1 : 2) extends <T>() => T extends Y ? 1 : 2 ? A : B;
declare const x1: <T>() => (T extends infer U extends number ? 1 : 0);
declare function f1(): <T extends {} | null | undefined>() => (T extends infer U extends number ? 1 : 0);
type ExpectNumber<T extends number> = T;
declare const x2: <T>() => (T extends ExpectNumber<infer U> ? 1 : 0);
declare function f2(): <T extends {} | null | undefined>() => (T extends ExpectNumber<infer U> ? 1 : 0);
